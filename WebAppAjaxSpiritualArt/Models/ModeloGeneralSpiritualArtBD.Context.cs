...
namespace WebAppAjaxSpiritualArt.Models
{
    ...
    public partial class BD_SPIRITUAL_ARTEntities : DbContext
    {
        ...
        public virtual int SP_REGISTRAR_ARTISTA(string nOMBRE_ARTISTA, string pRIMER_APELLIDO_ARTISTA, string sEGUNDO_APELLIDO_ARTISTA, string tELEFONO, string cORREO, string pAIS, string cIUDAD, string lOCALIDAD, string dIRECCION, Nullable<int> fK_TIPO_PLAN, Nullable<int> cLAVE, Nullable<bool> eSTADO, string iMAGEN)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_REGISTRAR_ARTISTA", nOMBRE_ARTISTAParameter, pRIMER_APELLIDO_ARTISTAParameter, sEGUNDO_APELLIDO_ARTISTAParameter, tELEFONOParameter, cORREOParameter, pAISParameter, cIUDADParameter, lOCALIDADParameter, dIRECCIONParameter, fK_TIPO_PLANParameter, cLAVEParameter, eSTADOParameter, iMAGENParameter);
        }
    
        public virtual int SP_REGISTRAR_NOTIFICACION(Nullable<int> fK_CLIENTE, Nullable<int> fK_ARTISTA, Nullable<int> fK_PRODUCTO)
        {
            ...
            var fK_ARTISTAParameter = fK_ARTISTA.HasValue ?
                new ObjectParameter("FK_ARTISTA", fK_ARTISTA) :
                new ObjectParameter("FK_ARTISTA", typeof(int));
    
            var fK_PRODUCTOParameter = fK_PRODUCTO.HasValue ?
                new ObjectParameter("FK_PRODUCTO", fK_PRODUCTO) :
                new ObjectParameter("FK_PRODUCTO", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_REGISTRAR_NOTIFICACION", fK_CLIENTEParameter, fK_ARTISTAParameter, fK_PRODUCTOParameter);
        }
    
        public virtual int SP_REGISTRO_CLIENTE(string nOMBRE_CLIENTE, string aPELLIDO_CLIENTE, string tELEFONO_CLIENTE, string eMAIL_CLIENTE, string aSUNTO, string mENSAJE, Nullable<int> fK_ARTISTA, Nullable<int> fK_PRODUCTO)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_REGISTRO_CLIENTE", nOMBRE_CLIENTEParameter, aPELLIDO_CLIENTEParameter, tELEFONO_CLIENTEParameter, eMAIL_CLIENTEParameter, aSUNTOParameter, mENSAJEParameter, fK_ARTISTAParameter, fK_PRODUCTOParameter);
        }
    }
}
