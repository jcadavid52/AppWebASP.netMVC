...
alter table REGISTRO_ARTISTA alter column clave varchar(20)
...
delete REGISTRO_ARTISTA where PK_ID_ARTISTA = 6059
--TABLA PLAN
DELETE TIPO_PLAN
...
delete PRODUCTO where  PK_ID_PRODUCTO = 3035
update PRODUCTO set ESTADO = 1 where PK_ID_PRODUCTO = 2006
--TABLA CATEGORIAS
...
(
PK_ID_CLIENTE INT PRIMARY KEY IDENTITY,
...
(
PK_ID_NOTIFICACION INT PRIMARY KEY IDENTITY,
FECHA DATE,
FK_CLIENTE INT REFERENCES CLIENTE(PK_ID_CLIENTE),
FK_ARTISTA INT REFERENCES REGISTRO_ARTISTA(PK_ID_ARTISTA),
FK_PRODUCTO INT REFERENCES PRODUCTO(PK_ID_PRODUCTO)
)
...
(
PK_ID_BIOGRAFIA INT PRIMARY KEY IDENTITY,
BIOGRAFIATEXTO VARCHAR(MAX),
FK_REGISTRO_ARTISTA INT REFERENCES REGISTRO_ARTISTA(PK_ID_ARTISTA)
)

select * from BIOGRAFIA
delete BIOGRAFIA where PK_ID_BIOGRAFIA = 2002
